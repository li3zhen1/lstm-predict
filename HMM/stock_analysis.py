...
python3 stock_analysis.py -n AAPL -s 2018-01-01 -e 2022-05-03 -o ./ -p True -f 5 -m True
"""
import warnings
import logging
import itertools
...
class HMMStockPredictor:
    ...
    def _split_train_test_data(self, test_size):
        ...
        # try:
        #     print("Downloading data for " + str(self.company))
        ...
        #     )
        #     sys.exit()
        # read data from "AAPL.csv" file
        used_data = pd.read_csv("/Users/lizhen/Desktop/GT23Fall/MachineLearning/project/archive/Technology Companies/AAPL.csv", index_col=0, parse_dates=True)
        print(len(used_data))
        ...
        print(self.days, " days of data will be used for testing.")
...
def plot_results(in_df, out_dir, stock_name):
    ...
    in_df.plot(kind="line", x="Date", y="Predicted_Close", ax=ax)
    plt.ylabel("Price")
    plt.title(str(stock_name) + " stock price prediction using HMM")
